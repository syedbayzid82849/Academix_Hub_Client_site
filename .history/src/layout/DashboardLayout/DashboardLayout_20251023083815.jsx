...
const DashboardLayout = () => {
  ...
  return (
    <div className="flex min-h-screen ">
      {/* Sidebar */}
      <div
        className={`fixed md:relative z-50 text-white h-full p-4 flex flex-col transition-all duration-300 ${isOpen ? "w-64" : "w-0 md:w-64"
          }`}
      >
        {/* Sidebar Header */}
      ...
      {/* Main Content */}
      <div className="flex-1 md:ml-0 mt-16 md:mt-0 p-6">
        <Outlet />
      </div>
    </div>
  );
