        ...
        >
            ...
            <form onSubmit={handleSubmit} className="space-y-4 ">
                ...
                <div className="w-32 mx-auto">
                    <Lottie animationData={animationData} loop={trueF} />
                </div>
                ...
                <input name="image" onChange={handleChange} type='url' value={formData.imageUrl} className="w-full p-3 border rounded-lg" placeholder="Image URL" required />
