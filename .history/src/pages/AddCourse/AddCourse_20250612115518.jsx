        ...
        >
            ...
            <form onSubmit={handleSubmit} className="space-y-4 ">
                ...
                <textarea
                    id="shortDescription"
                    rows="4"
                    className="shadow appearance-none border rounded w-full py-2 px-3 leading-tight focus:outline-none focus:shadow-outline resize-none" // resize-none দিয়ে ব্যবহারকারীকে টেক্সটবক্সের আকার পরিবর্তন করতে বাধা দেওয়া হয়েছে
