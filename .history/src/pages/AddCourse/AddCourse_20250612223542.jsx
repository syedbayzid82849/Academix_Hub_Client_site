    ...
    return (
        ...
        >
            ...
            <form onSubmit={handleSubmit} className="space-y-4 ">
                ...
                <input name="instructorName" type='text' onChange={handleChange} value={displayName} className="w-full p-3 border rounded-lg" placeholder="Name" required />
                <label className="block">Email: </label>
                <input name="instructorEmail" type='email' onChange={handleChange} value={email} className="w-full p-3 border rounded-lg" placeholder="Email" required />
