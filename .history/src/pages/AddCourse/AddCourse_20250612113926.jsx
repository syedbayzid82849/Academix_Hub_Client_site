    ...
    return (
        ...
        >
            ...
            <form onSubmit={handleSubmit} className="space-y-4 ">
                ...
                <input name="description" onChange={handleChange} type value={formData.description} className="w-full p-3 border rounded-lg" placeholder="Short Description" required />
