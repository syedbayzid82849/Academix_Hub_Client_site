...
import animationData from '../assets/animation.json'; // replace with your actual Lottie JSON
...
const AddCourse = () => {
  ...
  return (
    <motion.div
      ...
      className="max-w-xl mx-auto bg-white p-8 rounded-2xl shadow-md mt-10"
    >
