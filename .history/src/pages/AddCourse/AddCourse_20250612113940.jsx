    ...
    return (
        ...
        >
            ...
            <form onSubmit={handleSubmit} className="space-y-4 ">
                ...
                <input name="title" onChange={handleChange} t value={formData.title} className="w-full p-3 border rounded-lg" placeholder="Course Name" required />
                <label htmlFor="description" className="block">Short Description: </label>
                <input name="description" onChange={handleChange} type='text' value={formData.description} className="w-full p-3 border rounded-lg" placeholder="Short Description" required />
