...
const AddCourse = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res = await axios.post('https://academix-hub-server.vercel.app/all-course', newCourse);
            const data = res.data;
    ...
    return (
        ...
        >
            ...
            <form onSubmit={handleSubmit} className="space-y-4 ">
                ...
                <label className="block">                <label className="block">Duration: </label>
                <input name="duration" type='text' className="w-full p-3 border rounded-lg" placeholder="Duration" required />: </label>
