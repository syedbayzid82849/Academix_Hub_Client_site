    ...
    return (
        ...
        >
            ...
            <form onSubmit={handleSubmit} className="space-y-4 ">
                ...
                <input name="instructorName" type='text' de className="w-full p-3 border rounded-lg" placeholder="Name" required />
                <label className="block">Email: </label>
                <input name="instructorEmail" type='email' de className="w-full p-3 border rounded-lg" placeholder="Email" required />
