    ...
    return (
        ...
        >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <input name="instructorName" type='text' defaultValue={displayName} className="w-full p-3 border rounded-lg" di />

                <label className="block">Email: </label>
                <input name="instructorEmail" type='email' defaultValue={email} className="w-full p-3 border rounded-lg" di />
