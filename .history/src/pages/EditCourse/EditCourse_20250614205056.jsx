    ...
    return (
        ...
        >
            ...
            <form onSubmit={handleSubmit} className="space-y-4 ">
                ...
                <input defaultValue={title} name="title" type='text' className="w-full p-3 border rounded-lg" placeholder="Course Name" required />
                ...
                <input defaultValue={createdAt} type="date" name="createdAt" className="input input-bordered w-full" required />
                <label className="block">Image URL: </label>
                <input defaultValue={image} name="image" type='url' className="w-full p-3 border rounded-lg" placeholder="Image URL" required />
                <label className="block">Total Seats:</label>
                <input defaultValue={totalSeats} name="totalSeats" type='number' className="w-full p-3 border rounded-lg" placeholder="Total Seats" required />
                <label className="block">Duration: </label>
                <input defaultValue={duration} name="duration" type='text' className="w-full p-3 border rounded-lg" placeholder="Duration" required />
