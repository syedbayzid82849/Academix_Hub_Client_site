...
import animationData from '../../components/lotties/login.json';
        ...
        <div className="flex flex-col md:flex-row items-center justify-center min-h-screen px-10 gap-5  ">
            ...
            <div className="w-full mx-auto mt-5 max-w-md p-8 space-y-3 rounded-xl dark:bg-gray-50 dark:text-gray-800">
                ...
                <form noValidate="" action="" className="space-y-6">
                    ...
                    <button className="block w-full p-3 text-center dark:text-gray-50 dark:bg-blue-600 rounded-3xl">Sign in</button>
                </form>
