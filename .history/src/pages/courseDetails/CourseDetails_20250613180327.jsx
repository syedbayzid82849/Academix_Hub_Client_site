...
const CourseDetails = () => {
    ...
    const enrollledUserDetails = userEmail, _id ;
    console.log(enrollledUserDetails);
    ...
    const handleEnrollBtn = () => {
        ...
        axios
            .post('https://academix-hub-server.vercel.app/enrollled-users', )
            .then(res => {
                console.log(res);
                Swal.fire({
                    icon: 'success',
                    title: 'Course Added!',
                    text: 'Your Enroll has been successfully created.',
