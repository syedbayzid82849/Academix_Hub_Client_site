...
console.log(userEmail);
    ...
    const handleCancelEnroll = () => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                axios.delete(`https://academix-hub-server.vercel.app/all-course/${_id}?email=${userEmail}`)
                    .then(res => {
    ...
    return (
        <div className="max-w-4xl mx-auto px-4 py-10 bg-amber-50 mt-7 rounded-3xl">
            ...
            {!isSeatAvailable ? (
                <button
                    className='w-full mt-6 px-4 py-2 rounded font-semibold bg-blue-600 hover:bg-blue-700 text-white'
                    disabled
                >
                    No seats left
                </button>
