...
<div className="mt-6">
  {!user ? (
    <button
      disabled
      className="w-full px-4 py-2 rounded font-semibold bg-gray-400 cursor-not-allowed text-white"
    >
      Login to Enroll
    </button>
  ) : !isSeatAvailable ? (
    <button
      disabled
      className="w-full px-4 py-2 rounded font-semibold bg-red-400 cursor-not-allowed text-white"
    >
      No seats left
    </button>
  ) : isEnrolled ? (
    <button
      disabled
      className="w-full px-4 py-2 rounded font-semibold bg-green-500 cursor-not-allowed text-white"
    >
      Enrolled
    </button>
  ) : userEnrollCount >= 3 ? (
    <button
      disabled
      className="w-full px-4 py-2 rounded font-semibold bg-yellow-500 cursor-not-allowed text-white"
    >
      Limit Reached (3 Courses)
    </button>
  ) : (
    <button
