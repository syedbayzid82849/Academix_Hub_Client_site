...
const CourseDetails = () => {
    ...
    useEffect(() => {
        axios.get(`https://academix-hub-server.vercel.app/enrollled-users/${_id}`)
            .then(res => {
                console.log(res);
                if (res.data) {
    ...
    useEffect(() => {
        axios.get('https://academix-hub-server.vercel.app/enrollled-users')
        .then(res => {
            const totalEnrolled = res.data.length ;
        })
        .catch(err => {
            console.log(err);
        })
    ...
    return (
        <div className="max-w-4xl mx-auto px-4 py-10 bg-amber-50">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-gray-700">
                ...
                <p><span className="font-semibold">Enrolled:</span> {totalEnrolled}</p>
