...
const CourseDetails = () => {
    ...
    const handleEnrollBtn = () => {
        return toast.success('You have successfully enrolled in this course!', {
    ...
    return (
        <div className="max-w-4xl mx-auto px-4 py-10 bg-amber-50">
            ...
            <button onClick={() => handleEnrollBtn()} className="w-full mt-6 bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700 transition">
                Enroll Now
            </button>
        </div>
