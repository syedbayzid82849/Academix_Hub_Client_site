  ...
  if (courses.length === 0) {
    return (
      <section className="my-16 px-4 max-w-6xl mx-auto">
        ...
        <h2 className="text-3xl font-bold text-center mb-10 text-gray-900 dark:text-white">Our Courses</h2>
        <p className="text-center text-gray-600 dark:text-gray-400">No courses available at the moment.</p>
      </section>
    );
  }
