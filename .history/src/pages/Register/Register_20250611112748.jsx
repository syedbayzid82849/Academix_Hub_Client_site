...
const Register = () => {
    const { createUserWithEP, userWithGoogle } = useContext(AuthContext);
        ...
        <div className="flex flex-col md:flex-row items-center justify-center min-h-screen md:px-10 gap-5  ">
            ...
            <div className="w-full md:w-3/5 lg:w-2/5 mt-3 p-4 rounded-md shadow sm:p-8 dark:bg-gray-50 dark:text-gray-800">
                ...
                <div className="flex justify-center space-x-4 w-full my-4">
                    ...
                    <button onclick aria-label="Log in with GitHub" className=" p-3 rounded-sm">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-10 hover:text-yellow-400 hover:border-2  fill-current">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <input
                                ...
                                className="input input-bordered border-gray-300 w-full mb-3 border-1 bg-[#b1bac9]"
                                required
                            />                        </div>
                        {/* confirmPassword */}
                        <div className="space-y-2">
                            ...
                            <input name="confirmPassword" type="password" placeholder="Confirm Password" className="input input-bordered border-gray-300 w-full mb-3 border-1 bg-[#b1bac9]" required />
                        </div>
                    </div>
