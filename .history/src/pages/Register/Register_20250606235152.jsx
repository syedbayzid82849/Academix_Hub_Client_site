                ...
                <form onSubmit={handleRegister} className="space-y-8">
                    <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <input name="name" type="text" placeholder="Name" className="input input-bordered border-gray-300 w-full mb-3 border-1 bg-[3]" required />
                        </div>
                        {/* photo */}
                        <div className="space-y-2">
                            <label htmlFor="photo" className="block text-sm">Photo URL</label>
                            <input name="photo" type="text" placeholder="Photo URL" className="input input-bordered border-gray-300 w-full mb-3 border-1 bg-[3]" required />
                        </div>
                        {/* email */}
                        <div className="space-y-2">
                            <label htmlFor="email" className="block text-sm">Email address</label>
                            <input name="email" type="email" placeholder="Email" className="input input-bordered border-gray-300 w-full mb-3 border-1 bg-[3]" required />
                        </div>
                        {/* password */}
                        <div className="space-y-2">
                            <div className="flex justify-between items-center">
                                <label htmlFor="password" className="text-sm">Password</label>
                                <button type="button" onClick={() => setShowPassword(!showPassword)} className="text-xs text-blue-600">
                            ...
                            <input
                                ...
                                className="input input-bordered border-gray-300 w-full mb-3 border-1 bg-[3]"
                                required
                            />                        </div>
                        {/* confirmPassword */}
                        <div className="space-y-2">
                            ...
                            <input name="confirmPassword" type="password" placeholder="Confirm Password" className="input input-bordered border-gray-300 w-full mb-3 border-1 bg-[3]" required />
                        </div>
                    </div>
