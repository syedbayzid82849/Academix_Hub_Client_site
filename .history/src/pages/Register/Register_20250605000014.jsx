...
const Register = () => {
    ...
    return (
        <div className="flex flex-col md:flex-row items-center justify-center min-h-screen px-4">
            {/* Registration Form */}
            <div className="w-full md:w-1/2 bg-white mt-3 p-8 rounded-xl shadow-lg">
                ...
                <form onSubmit={handleRegister}>
                    ...
                    <button type="submit" className="btn bg-blue-600 rounded-2xl py-2 w-full">Register</button>
                </form>
            </div>
            {/* Lottie Animation */}
            <div className="w-full md:w-1/3 mxaut">
