...
const Register = () => {
    ...
    return (
        <div className="flex flex-col md:flex-row items-center justify-center min-h-screen px-10border">
            {/* Registration Form */}
            <div className="borderw-[70%] max-w-md mt-3 p-4 rounded-md shadow sm:p-8 dark:bg-gray-50 dark:text-gray-800">
