                        ...
                        {myCourses?.map(course => (
                            <tr key={course._id} className="border-t">
                                ...
                                <td className="p-2 border  md:flex gap-2">
                                    <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py- px-3 rounded focus:outline-none focus:shadow-outline text-xs">
                                        Edit
                                    </button>
                                    <button
                                        onClick={handleDelete}
                                        className="bg-red-500 hover:bg-red-700 text-white font-bold py- px-3 rounded focus:outline-none focus:shadow-outline text-xs"
                                    >
                                        Delete
                                    </button>
                                </td>
