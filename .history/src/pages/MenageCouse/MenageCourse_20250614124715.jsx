                        ...
                        {myCourses?.map(course => (
                            <tr key={course._id} className="border-t">
                                ...
                                <td className="p-2 border  md:flex gap-2">
                                    <button type="button" className="px-8 py-3 font-semibold border rounded dark:border-gray-800 dark:text-gray-800">Edit</button>
                                    <button type="button" className="px-8 py-3 font-semibold border rounded <button type="button" className="px-8 py-3 font-semibold border rounded dark:border-gray-800 dark:text-gray-800">Border</button>">Delete</button>
                                </td>
                            </tr>
                        ))}
                        {myCourses?.length === 0 && (
