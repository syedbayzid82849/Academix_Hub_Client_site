                    ...
                    <tbody>
                        {myCourses?.map(course => (
                            <tr key={course._id} className="border-t">
                                ...
                                <td className="p-2 border grid md:col-end-2 gap-3">
                                    <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-3 px-5 sm: rounded focus:outline-none focus:shadow-outline text-xs">
                                        Edit
                                    </button>
                                    <button
