        ...
        <section className="mt-10">
            <div className="px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {latestCourses.map(({ _id, title, image, createdAt, instructorName }) => (
                        <motion.div
                            key={_id}
                            ...
                            <div className="flex flex-col max-w-lg p-6 space-y-6 overflow-hidden rounded-lg shadow-md dark:bg-gray-50 dark:text-gray-800">
                                <div className="flex space-x-4">
                                    ...
                                    <div className="flex flex-col space-y-1">
                                        <a rel="noopener noreferrer" href="#" className="text-sm font-semibold">Instructor Name: {instructorName}</a>
                                        {/* <span className="text-xs dark:text-gray-600">4 hours ago</span> */}
                                    </div>
                                </div>
                                <div>
                                    <img src={image} alt="" className=" w-full mb-4 h-32 sm:h-48 dark:bg-gray-500" />
                                    <h2 className="mb-1 text-xl font-semibold">{title}</h2>
                                    <p className="text-sm dark:text-gray-600">{createdAt}</p>
                                </div>
