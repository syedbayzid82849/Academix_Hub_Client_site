...
const HomeCourseComponent = () => {
    ...
    return (
        <section className="mt-20 contai mx-auto">
            <div className="px-3">
                <h2 className="text-3xl font-bold mb-10 text-center text-gray-900 dark:text-white">Latest Courses</h2>

                <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-3">
                    {filteredCourses.map(({ title, image, _id, createdAt, description }) => (
                        <motion.div
                            key={_id}
                            className="bg-white dark:bg-gray-800 shadow-md rounded-xl overflow-hidden flex flex-col"
                            ...
                            <div className="p-4 flex flex-col flex-grow">
                                ...
                                <div className="mt-auto">
                                    ...
                                    <NavLink
                                        ...
                                        className="inline-block bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700 transition text-center w-full"
                                    >
                                        View Details
                                    </NavLink>
                                </div>
