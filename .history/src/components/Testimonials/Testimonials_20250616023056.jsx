        ...
        [
            {
                "id": 1,
                "name": "Abdur Rahman",
                "image": "https://www.vecteezy.com/photo/46386350-portrait-of-indian-college-boy-holding-books"                                    ,
                "rating": 5,
            ...
            <div className="grid md:grid-cols-3 gap-6">
                {testimonials.map(({ id, name, image, rating, feedback}) => (
                    <div key={id} className="bg-white p-6 rounded-2xl shadow-lg">
                        <img src={image} alt="Student image" className="w-16 h-16 rounded-full mx-auto mb-4" />
