    ...
    return (
        <header className="p-2 bg-gray-100 text-gray-800 shadow-md">
            <div className="container mx-auto flex justify-between items-center h-16">
                {/* Logo */}
                <NavLink to="/" className="border-2 flex items-center space-x-2 text-xl font-bold">
                    ...
                    <span className='flex border-2 justify-start font-bold text-2xl tracking-wide text-violet-600 italic'>HobbyHub</span>
                </NavLink>
