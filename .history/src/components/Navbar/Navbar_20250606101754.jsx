                ...
                <div className="hidden lg:flex gap-5 flex items-center">
                    {
                        user ?
                            (<>
                                <NavLink to="/profile" className={navLinkClass}><FaCircleUser className='text-4xl hover:text-violet-600 ' />
                                </NavLink>
                                <div className="absolute left-1/2 -translate-x-1/2 top-full mt-1 px-2 py-1 bg-black text-white text-sm rounded opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                                    {user.displayName || 'Guest User'}
                                </div>
                                <NavLink to="/logout" className="px-4 py-2 font-semibold rounded bg-violet-600 text-white hover:bg-violet-700">Logout</NavLink>
                            </>) :
                            (<>
