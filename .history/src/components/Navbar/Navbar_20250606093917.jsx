                ...
                <div className="hidden lg:flex gap-2">
                    {
                        user ?
                            (<>
                                ...
                                <NavLink to="/logout" className="px-4 py-2 font-semibold rounded bg-violet-600 text-white hover:bg-violet-700">Sign up</NavLink>

                                <NavLink to="/" className={navLinkClass}>Logout</NavLink>
                            </>) :
                            (<>
