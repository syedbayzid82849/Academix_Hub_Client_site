...
const Hero = () => {
    ...
    return (
        <Slider {...settings}>
            <div className="relative h-[400px] bg-cover bg-center" style={{ backgroundImage: `url(${banner1})` }}>
            ...
            <div className="relative h-[400px] bg-cover bg-center" style={{ backgroundImage: `url(${banner2})` }}>
