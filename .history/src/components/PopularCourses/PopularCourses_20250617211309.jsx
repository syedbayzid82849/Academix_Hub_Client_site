...
import { NavLink } from 'react-router-dom'; // 'react-router' নয়, react-router-dom হতে হবে
    ...
    return (
        <section className="mt-16 px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {courses?.map(course => (
                    <div key={course.courseId} className="border p-4 rounded-lg shadow-md">
                        ...
                        <NavLink to={`/courseDetails/${course.courseId}`}>
