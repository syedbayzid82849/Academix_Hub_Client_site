...
import { NavLink } from 'react-router-dom'; // ✅ should use 'react-router-dom' not 'react-router'
            ...
            <div className="max-w-6xl mx-auto text-center">
                ...
                <div className="grid gap-8 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                    {filteredCourses.map(course => (
                        <div
                            key={course._id}
                            className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 p-5 rounded-2xl shadow-md hover:shadow-xl transition-all duration-300"
                        >
                            <img
                                src={course.image}
                                alt={course.title}
                            ...
                            <div className="mt-4 text-left">
                                ...
                                <NavLink to={`/courseDetails/${course._id}`}>
                                    <button className="mt-4 w-full py-2 rounded-lg bg-blue-600 hover:bg-blue-700 text-white dark:bg-blue-500 dark:hover:bg-blue-600 transition">
                                        View Details
                                    </button>
                                </NavLink>
                            </div>
