    ...
    return (
        <section className='my-16 px-4 border-2 rounded-3xl mt-28'>
            <div className=" p-8 rounded-2xl text-center">
                ...
                <div className="flex justify-center gap-2 px">
                    <input value={email} onChange={(e) => setEmail(e.target.value)} type="email" placeholder="Enter your email" className="px-16 py-2 rounded-l-lg border" />
