...
const StayUpdateSection = () => {
    ...
    return (
        <section className="my-20 px-4">
            <div className=" container mx-auto bg-gradient-to-br from-violet-500 to-blue-600 dark:from-violet-700 dark:to-blue-800 px4 rounded-3xl text-center shadow-xl">
