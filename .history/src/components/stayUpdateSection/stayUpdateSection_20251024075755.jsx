...
const StayUpdateSection = () => {
    ...
    return (
        <section className="my-20 px-4">
            <div className=" container p mx-auto bg-gradient-to-br from-violet-500 to-blue-600 dark:from-violet-700 dark:to-blue-800 py-10 rounded-3xl text-center shadow-xl">
