...
const StayUpdateSection = () => {
    ...
    return (
        <section className="my-24 px-3 max-w-7xl mx-auto">
            <div className="  bg-gradient-to-br from-violet-500 to-blue-600 dark:from-violet-700 dark:to-blue-800 py-10 rounded-3xl text-center shadow-xl">
