...
const Footer = () => {
    return (
        <footer className="bg-white shadow-md transition-colors duration-300 dark:bg-[#131313] text-gray-800 dark:text-gray-200 py-10 px-5 mt-16 transition-colors duration-300">
