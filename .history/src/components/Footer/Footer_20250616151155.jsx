                ...
                <div className="mx">
                    ...
                    <div className="flex gap-3 mt-4">
                        <a href="#" aria-label="Facebook">
                            <FaFacebook className="w-16 text-xl hover:text-blue-500 transition" />
                        </a>
                        <a href="#" aria-label="Youtube">
                            <FaYoutube className="w-16 text-xl hover:text-red-600 transition" />
                        </a>
                        <a href="#" aria-label="GitHub">
                            <FaGithub className="w-16 text-xl hover:text-gray-400 transition" />
                        </a>
                    </div>
                </div>
